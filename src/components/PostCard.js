...
const PostCard = (props) => {
  ...
  return (
    <Card>
      ...
      >
        <Avatar
          containerStyle={{ backgroundColor: "#38a4a4", marginTop: 10 }}
          rounded
          size={50}
      ...
      <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
        <Button
          titleStyle={{color: "#38a4a4"}}
          type="outline"
          title= {"Like (" + LikesCount + ")"}
          icon={<AntDesign name="like2" size={24} color="#38a4a4" />}
          onPress={ function () {
        ...
        <Button type="solid" title={"Comments (" + CommentsCount + ")"}
          buttonStyle={{backgroundColor: "#38a4a4"}}
          onPress={ function () {
